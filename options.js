...
const POPULAR_URL_RULES = [
  ...
  ["instagram.com", 10], ["x.com", 10], ["reddit.com", 15]
].map(([pattern, idleMinutes]) => ({ pattern, idleMinutes }));
const defaults = { idleMinutes: 5, whitelist: PWA_EXCLUSIONS, urlRules: POPULAR_URL_RULES, discardPinned: false, discardAudio: false };
